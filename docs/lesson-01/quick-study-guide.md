...
!!! warning "Exam point"
    **802.11 (Wi‑Fi) link-layer error correction is not** an end-to-end violation — it compensates for a noisy medium. End hosts can still add their own reliability. **NAT**, **firewalls**, **proxies**, and **DPI** **are** violations.
