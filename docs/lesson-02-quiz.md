...
Transport layer, TCP, UDP, and congestion control. See the [Quick Study Guide](lesson-02-quick-study-guide.md) for written answers.
...
!!! tip "Keep studying"
    - [Full Lesson 2 guide](lesson-02-transport-application.md)
